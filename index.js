...
let useEmulator = process.env.NODE_ENV === 'development' || process.env.NODE_ENV === 'localhost';

const connector = new builder.ChatConnector({
    appId: process.env['MicrosoftAppId'] || 'CHANGE_ME',
    appPassword: process.env['MicrosoftAppPassword'] || 'CHANGE_ME=',
